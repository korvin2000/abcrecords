...
export const ko: Record<MsgKey, Message> = {
  ...
  "guestbook.close": "✕ 방명록 닫기",
  "guestbook.error": "방명록을 열지 못했습니다. 페이지를 새로 고친 뒤 다시 시도해 주세요.",
  ...
  "counter.label": "방문자",
  "counter.open": "방문 통계",
  "counter.silent": "계수기가 조용합니다 — 집계를 읽을 수 없습니다",

  "stats.title": "방문자 연대기",
  "stats.since": "{date}부터 기록 · {days}",
  "stats.dayCount": "{v}일",
  "stats.views": "{v}회 열람",
  "stats.close": "닫기",
  "stats.retry": "다시 시도",
  "stats.loading": "독자를 세는 중…",
  "stats.error": "방문자 연대기를 읽지 못했습니다.",
  "stats.privacy": "쿠키도 주소도 없이, 집계만.",
  "stats.empty": "아직 기록이 없습니다.",
  "stats.entryUnknown": "목록에 없음",

  "stats.tile.uniques": "독자",
  "stats.tile.views": "열린 페이지",
  "stats.tile.visits": "방문",
  "stats.tile.today": "오늘",
  "stats.tile.online": "지금 열람 중",

  "stats.days.title": "지난 삼십 일",
  "stats.days.hint": "7일 {d7} · 30일 {d30}",
  "stats.hours.title": "오늘, 시간별",
  "stats.hours.hint": "가장 붐빈 시각: {hour} · {n}",
  "stats.week.title": "요일별",
  "stats.pages.title": "가장 많이 읽힌 항목",
  "stats.langs.title": "언어별 독자",
  "stats.tech.title": "읽기의 도구",
  "stats.refs.title": "어디에서 왔는가",
  "stats.refs.none": "모든 방문이 코덱스로 곧바로 왔습니다.",
  "stats.records.title": "여백의 기록",

  "stats.tech.device": "기기",
  "stats.tech.browser": "브라우저",
  "stats.tech.os": "시스템",
  "stats.device.desktop": "데스크톱",
  "stats.device.mobile": "휴대폰",
  "stats.device.tablet": "태블릿",
  "stats.other": "기타",

  "stats.record.peakDay": "가장 붐빈 날",
  "stats.record.peakHour": "가장 붐빈 시각",
  "stats.record.streak": "연속 일수",
  "stats.record.perDay": "하루 페이지",
  "stats.record.perVisit": "방문당 페이지",
  "stats.record.bots": "물러난 크롤러",
};
