...
export const ru = {
  ...
  // Две встраиваемые части (packages/): демосцена за кнопкой «I» в шапке
  // и гостевая книга за пунктом VI в подвале.
  "about.open": "О кодексе",

  "guestbook.close": "✕ Закрыть гостевую книгу",
  "guestbook.error": "Гостевая книга не открылась. Обновите страницу и попробуйте снова.",
